...
class DataIngestion:
    ...
    def extract_tgz_file(self,tgz_file_path:str):
        ...
        try :
            ...
            logging.info(f"extracting tgz_file : [{tgz_file_path}] into dir : [{raw_data_dir}]")
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            for train_index , test_index in split.split(housing_data_frame ,groups= housing_data_frame["income_cat"]):
            ...
            data_ingesttion_artifact = DataIngestionArtifact(train_file_path=train_file_path ,test_file_path=test_file_path ,is_ingested=True ,message= "ingestion completed")
            logging.info(f"Data Ingestion Artifat :[{data_ingesttion_artifact}]")
    ...
    def __del__(self):
        logging.info(f"{'='*20} data ingestion log completd {'='*20} \n \n ")
