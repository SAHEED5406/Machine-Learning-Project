...
class DataValidation:
    ...
    def __init__(self,
                ...
                data_ingestion_artifact:DataIngestionArtifact)->DataValidationConfig:
        try:
    ...
    def get_train_and_test_df(self):
        try:
            train_df = pd.read_csv(f"{self.data_ingestion_artifact.train_file_path}")
            test_df = pd.read_csv(f"{self.data_ingestion_artifact.test_file_path}")
